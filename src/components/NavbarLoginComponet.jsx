        ...
        <div className="flex md:order-2">
          ...
          <div className="flex justify-end">
            ...
            <Menu as="div" className="relative inline-block">
              ...
              <Menu.Button className="inline-flex justify-center items-center space-x-2 border font-semibold rounded-lg px-3 py-2 leading-5 text-sm text-black hover:text-black hover:border-blue-600  focus:ring-blue-200 focus:ring-opacity-50 active:bg-blue-200 active:border-blue-700 dark:focus:ring-blue-400 dark:focus:ring-opacity-90">
              <img className="flex-none inline-block w-8 h-8 sm:w-12 sm:h-12 rounded-full mt-1" src="https://cdn.tailkit.com/media/placeholders/avatar-mEZ3PoFGs_k-160x160.jpg" alt="User Avatar" />
                <span>Akbar Ananda</span>
                <svg
                  className="hi-mini hi-chevron-down inline-block w-4 h-4 opacity-50"
              ...
              >
                <Menu.Items className="absolute right-0 origin-top-right z-10 mt-2 w-48 shadow-xl rounded-lg dark:shadow-gray-900 focus:outline-none">
                  <div className="bg-white ring-1 ring-black ring-opacity-5 rounded-lg divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700 dark:ring-gray-700">
...
export default NavbarLoginComponet;
